...
fn en(key: TextKey) -> &'static str {
    match key {
        ...
        TextKey::ReviewHint => "Review this result manually before trusting it.",
...
fn ru(key: TextKey) -> &'static str {
    match key {
        ...
        TextKey::ReviewHint => "Перед доверием к результату вручную проверьте этот результат.",
